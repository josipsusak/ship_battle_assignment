class TestIntegration:
    ...
    # Tests if app is working when proper query parameters are input, asserting "Winner is", because it's only inside of
    # response if app is working properly and results are calculated
